  ...
  return (
    <div className="flex flex-col min-h-screen bg-background p-6 animate-fade-in">
      <header className="py-4 flex items-center">
        ...
        <h2 className="text-xl font-headline font-bold ml-2 text-foreground">Join Zynqo</h2>
      </header>

      <div className="flex-1 mt-6 space-y-6 overflow-y-auto no-scrollbar pb-8">
        <div className="space-y-2">
          <h3 className="text-3xl font-headline font-bold text-foreground">Create Account</h3>
          <p className="text-muted-foreground text-sm">Start your social journey today</p>
        </div>

        <div className="flex flex-col items-center gap-4 py-4">
          <div className="relative group">
            <Avatar className="w-24 h-24 border-2 border-dashed border-primary/40 p-1 bg-white">
        ...
        <form className="space-y-4" onSubmit={handleSignUp}>
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input name="username" value={formData.username} onChange={handleChange} placeholder="alex_z" className="h-12 pl-10 bg-muted border-border rounded-2xl focus-visible:ring-primary text-foreground" required />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input name="displayName" value={formData.displayName} onChange={handleChange} placeholder="Alex Rivers" className="h-12 pl-10 bg-muted border-border rounded-2xl focus-visible:ring-primary text-foreground" required />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input name="email" type="email" value={formData.email} onChange={handleChange} placeholder="name@example.com" className="h-12 pl-10 bg-muted border-border rounded-2xl focus-visible:ring-primary text-foreground" required />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input name="password" type="password" value={formData.password} onChange={handleChange} placeholder="••••••••" className="h-12 pl-10 bg-muted border-border rounded-2xl focus-visible:ring-primary text-foreground" required />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground" size={16} />
              <Input name="confirmPassword" type="password" value={formData.confirmPassword} onChange={handleChange} placeholder="••••••••" className="h-12 pl-10 bg-muted border-border rounded-2xl focus-visible:ring-primary text-foreground" required />
            </div>
          </div>
      ...
      <div className="py-8 text-center bg-background sticky bottom-0 border-t border-border">
