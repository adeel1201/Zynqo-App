...
import { doc, updateDoc, arrayUnion, arrayRemove, query, collection, where, orderBy } from 'firebase/firestore';
    ...
    <div className="flex flex-col min-h-screen bg-[#0E0C12] text-white pb-20 animate-fade-in">
      ...
      <div className="mt-8 flex items-center justify-center border-y border-white/5 bg-card/20">
         <button className="flex-1 py-4 flex flex-col items-center gap-1 border-b-2 border-primary">
            ...
            <span className="text-[9px] font-black uppercase tracking-widest text-primary">All Posts</span>
         </button>
         <button className="flex-1 py-4 flex flex-col items-center gap-1 opacity-40">
            <VideoIcon size={20} />
