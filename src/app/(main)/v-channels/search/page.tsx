      ...
      <div className="p-4 space-y-8">
         <div className="flex gap-2 overflow-x-auto no-scrollbar py-2">
            {['Following', 'Recommended', 'Live', 'Music', 'Tech', 'Food', 'Travel'].map(cat => (
              <Button key={cat} variant="outline" size="sm" className="rounded-full border-white/10 bg-white/5 text- font-black uppercase tracking-widest px-6 h-9 hover:bg-primary/10 hover:text-primary">
                {cat}
              </Button>
            ))}
         </div>
         ...
         <section className="space-y-4">
            <div className="flex items-center justify-between px-2">
               <h3 className="text- font-black uppercase tracking-[0.2em] text-muted-foreground flex items-center gap-2">
            ...
            {loading? (
              ...
              <div className="flex flex-col gap-3">
                 {filteredCreators.map((creator: any) => (
                   <div
                     ...
                     className="flex items-center justify-between bg-card/40 p-4 rounded-3xl border-white/5 hover:bg-white/5 transition-all cursor-pointer group"
                   >
                      <div className="flex items-center gap-4">
                         <Avatar className="h-12 w-12 rounded-2xl border-primary/20">
                         ...
                         <div>
                            ...
                            <div className="flex items-center gap-2 mt-0.5">
                               <p className="text- text-muted-foreground font-medium uppercase tracking-widest">@{creator.username}</p>
                      ...
                      <Button variant="ghost" size="sm" className="text-primary text- font-black uppercase tracking-widest rounded-xl hover:bg-primary/10 px-4">
                         Visit
                      </Button>
                   </div>
                 ))}
              ...
              <div className="py-20 text-center text-muted-foreground bg-card/20 rounded- border-dashed border-white/5">
