      ...
      <div className="p-4 space-y-6">
        ...
        <section className="space-y-2">
          ...
          <div className="bg-card/40 rounded-[2rem] border border-white/5 overflow-hidden">
            ...
            <div className="p-4 border-b border-white/5 last:border-none">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-sm font-medium">Zynqo Version</span>
...
function SettingsItem({ icon: Icon, label, href }: { icon: any, label: string, href: string }) {
  return (
    <Link href={href} className="flex items-center justify-between p-4 hover:bg-white/5 transition-colors border-b border-white/5 last:border-none">
      <div className="flex items-center gap-3">
