...
export default function SecuritySettingsPage() {
  ...
  const [isVerifying, setIsVermitting] = useState(false);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0E0C12] animate-fade-in pb-24">
      <header className="sticky top-0 z-40 bg-card/80 backdrop-blur-xl safe-top px-2 h-16 flex items-center border-b border-white/5">
        ...
        <h2 className="font-bold text-lg">Advanced Security</h2>
      </header>

      <div className="p-4 space-y-8">
        {/* Security Health Card */}
        <div className="bg-primary/10 border border-primary/20 p-6 rounded-[2.5rem] flex flex-col items-center text-center gap-4 relative overflow-hidden">
          ...
          <div className="space-y-1">
            <h3 className="text-lg font-bold">Security Score: {isEmailVerified ? 'Excellent' : 'Action Required'}</h3>
        ...
        <section className="space-y-3">
          ...
          <div className="bg-card/40 rounded-[2.5rem] border border-white/5 divide-y divide-white/5 overflow-hidden">
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <span className="text-[8px] bg-white/5 text-muted-foreground px-2 py-0.5 rounded-full font-black uppercase tracking-widest">Setup</span>
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between px-2">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-headline font-bold text-lg">Login Activity</h3>
            </div>
          </div>
        ...
        {/* Account Recovery */}
        <div className="bg-card/30 p-6 rounded-[2.5rem] border border-dashed border-white/10 flex items-start gap-4">
           <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-muted-foreground shrink-0">
              <AlertCircle size={24} />
           </div>
