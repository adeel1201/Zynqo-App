  ...
  return (
    <div className="flex flex-col min-h-screen bg-background animate-fade-in pb-24">
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-xl safe-top px-2 h-16 flex items-center border-b border-border">
        ...
        <h2 className="font-bold text-lg text-foreground">Account Management</h2>
      </header>
      ...
      <div className="p-4 space-y-6">
        ...
        <section className="space-y-3">
          ...
          <div className="bg-card rounded-[2.5rem] border border-border overflow-hidden shadow-sm">
            <button className="w-full flex items-center justify-between p-5 hover:bg-muted/30 transition-colors text-left border-b border-border">
            ...
            <button className="w-full flex items-center justify-between p-5 hover:bg-muted/30 transition-colors text-left">
              <div className="flex items-center gap-4">
              ...
              <span className="text-[8px] bg-secondary/10 text-secondary px-2 py-0.5 rounded-full font-black uppercase tracking-tighter">Disabled</span>
            </button>
          </div>
        </section>
        ...
        <section className="space-y-3">
          ...
          <div className="bg-card rounded-[2.5rem] border border-border overflow-hidden shadow-sm">
            <button 
              ...
              className="w-full flex items-center gap-4 p-5 hover:bg-muted/30 transition-colors text-left border-b border-border"
            >
            ...
            <AlertDialog>
              ...
              <AlertDialogContent className="bg-white border-border rounded-[2rem]">
                <AlertDialogHeader>
                ...
                <AlertDialogFooter className="mt-6">
                  <AlertDialogCancel className="rounded-xl border-border bg-muted">Cancel</AlertDialogCancel>
                  <AlertDialogAction onClick={handleDeleteAccount} className="rounded-xl bg-destructive hover:bg-destructive/90 text-white">
...
function AccountInfo({ icon: Icon, label, value }: any) {
  return (
    <div className="flex items-center justify-between p-5 border-b border-border last:border-none">
      <div className="flex items-center gap-4">
        <div className="w-10 h-10 rounded-2xl bg-muted flex items-center justify-center text-muted-foreground">
          <Icon size={20} />
        </div>
