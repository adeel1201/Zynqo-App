...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyAJsRPwCQY9hFKpq8F7TW1Z3X6hxV7bv3U") || "",
    authDomain: ("TURBOPACK compile-time value", "zynqo-a2fe.firebaseapp.com") || "",
    projectId: ("TURBOPACK compile-time value", "zynqo-a2fe") || "",
    storageBucket: ("TURBOPACK compile-time value", "zynqo-a2fe.firebasestorage.app") || "",
    messagingSenderId: ("TURBOPACK compile-time value", "579176101413") || "",
    appId: ("TURBOPACK compile-time value", "1:579176101413:web:5b8fe59463d439d6d271cc") || ""
};
...
'use client';
;
class FirebaseErrorEmitter extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$events$2f$events$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventEmitter"] {
    emit(event, error) {
        return super.emit(event, error);
    }
}
const errorEmitter = new FirebaseErrorEmitter();
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function FirebaseProvider(param) {
    let { children, app, auth, db, storage } = param;
...
function FirebaseClientProvider(param) {
    let { children } = param;
    _s();
    const { app, auth, db, storage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
...
_s(FirebaseClientProvider, "6xe/MhTaG5R3LCbXVIq66/duC7k=");
...
class FirestorePermissionError extends Error {
    constructor(context){
        super("Firestore Permission Denied: ".concat(context.operation, " on ").concat(context.path)), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "context", void 0);
...
function useDoc(ref) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDoc.useEffect": ()=>{
            const path = (ref === null || ref === void 0 ? void 0 : ref.path) || 'unknown_doc';
            // Guard: Wait for both the reference and a truly authenticated user session.
            if (!ref || !(auth === null || auth === void 0 ? void 0 : auth.currentUser)) {
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(ref, {
                "useDoc.useEffect.unsubscribe": (doc)=>{
                    setData(doc.exists() ? {
                        id: doc.id,
                        ...doc.data()
                    } : null);
                ...
                "useDoc.useEffect.unsubscribe": async (error)=>{
                    if ((auth === null || auth === void 0 ? void 0 : auth.currentUser) && error.code === 'permission-denied') {
        ...
        ref === null || ref === void 0 ? void 0 : ref.path,
        auth === null || auth === void 0 ? void 0 : (_auth_currentUser = auth.currentUser) === null || _auth_currentUser === void 0 ? void 0 : _auth_currentUser.uid
    ]);
    return {
        data,
        loading
...
_s(useDoc, "kqvfpCSWaRU0MOyeGVUxQV2C9d4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCollection.useEffect": ()=>{
            ...
            try {
                ...
                path = ((__query = q._query) === null || __query === void 0 ? void 0 : (__query_path = __query.path) === null || __query_path === void 0 ? void 0 : (__query_path_segments = __query_path.segments) === null || __query_path_segments === void 0 ? void 0 : __query_path_segments.join('/')) || q.path || 'collection_query';
            } catch (e) {}
            // Guard: Wait for both the query and a truly authenticated user session.
            if (!q || !(auth === null || auth === void 0 ? void 0 : auth.currentUser)) {
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q, {
                ...
                "useCollection.useEffect.unsubscribe": async (serverError)=>{
                    // Only emit permission error if we actually have a user, 
                    // otherwise it's just a transient auth transition state.
                    if ((auth === null || auth === void 0 ? void 0 : auth.currentUser) && serverError.code === 'permission-denied') {
                        const permissionError = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirestorePermissionError"]({
                            path: path,
                            operation: 'list'
                        });
...
_s(useCollection, "UpaDRyFsCKHsXwiZ3qMQp19tm5s=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
"[project]/src/firebase/firestore/use-memo-firebase.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useMemoFirebase(factory, deps) {
    ...
    const depsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
...
_s(useMemoFirebase, "2ZKkVHSc0E/khvbHnw6vxLZrA+o=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function initializeFirebase() {
    const hasConfig = !!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firebaseConfig"].apiKey && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firebaseConfig"].apiKey !== "undefined" && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firebaseConfig"].apiKey !== "";
    if (!hasConfig) {
        return {
            app: null,
            auth: null,
...
const AuthProvider = (param)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const unsubscribeAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChanged"])(auth, {
                "AuthProvider.useEffect.unsubscribeAuth": (authUser)=>{
                    setUser(authUser);
                    ...
                    if (authUser && db) {
                        const docRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(db, "users", authUser.uid);
                        unsubscribeProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(docRef, {
        ...
        "AuthProvider.useEffect": ()=>{
            if (!loading) {
                ...
                const isPublicPath = publicPaths.some({
                    "AuthProvider.useEffect.isPublicPath": (path)=>pathname === null || pathname === void 0 ? void 0 : pathname.startsWith(path)
...
_s(AuthProvider, "lpYm0ov/xnTmdhQ4fSuLKwNEwhw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=src_d7c22e74._.js.map